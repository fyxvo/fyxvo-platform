...
export const FYXVO_DEVNET_PROTOCOL_CONFIG = "J4uiLhB3qaYUFvu6YAT6oTrBbe7qXfwZFfLm2ph5GTAH";
export const FYXVO_DEVNET_TREASURY = "HvgY6dGviH5xosaHvVBNKwt2gTTnJYJ9aG7dWC4wqST1";
export const FYXVO_DEVNET_OPERATOR_REGISTRY = "9k4Xr4qfVMSN14aNkFdDFHbd74syujkyYcGKGTWYxmRQ";
export const FYXVO_DEVNET_TREASURY_USDC_VAULT = "2epkxnyGfX6FPYRmPa2tystcd1UrvjYFR5wJh6uKZj5i";
